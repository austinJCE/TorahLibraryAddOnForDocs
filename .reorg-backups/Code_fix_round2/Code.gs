...
function basicHTML() {
  let template = HtmlService.createTemplateFromFile('basic');
  let basicHTMLOutput = template.evaluate()
    .setTitle('Basic Search')
    .setWidth(300);
  DocumentApp.getUi().showSidebar(basicHTMLOutput);
}
...
function getTypographySettings() {
  ...
  return {
    ...
    translationFont: userProperties.getProperty("translation_font") || "Crimson Text",
    ...
    transliterationFont: userProperties.getProperty("transliteration_font") || "Crimson Text",
    ...
    sourceTitleFont: userProperties.getProperty("source_title_font") || "Frank Ruhl Libre",
    ...
    sefariaLinkFont: userProperties.getProperty("sefaria_link_font") || "Frank Ruhl Libre",
...
function getDefaultPreferences() {
  return {
    ...
    teamim: true,
    teamim_filter: "available",
    translation_font: "Crimson Text",
    translation_font_size: 12,
    translation_font_style: "normal",
    transliteration_font: "Crimson Text",
