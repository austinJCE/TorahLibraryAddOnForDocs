  ...
  function applyLayoutClass() {
    ...
    document.querySelector('.translation-version-control').style.display = value === 'he' ? 'none' : 'block';
    document.querySelector('.advanced-version-details').style.display = value === 'en' ? 'none' : 'block';
    ...
    var layoutValue = value === 'stack' ? 'he-top' : (value === 'sbs' ? 'he-right' : 'he-right');
    document.querySelector('.bilingual-layout-wrapper').style.display = value === 'en' || value === 'he' ? 'none' : '';
  ...
  function getInsertionOptions() {
    ...
    var bilingualLayout = preferences.bilingual_layout_default || 'he-right';
  ...
  document.querySelectorAll('.mode-card').forEach(function(button) {
    button.addEventListener('click', function() {
      ...
      document.getElementById('addFormat').value = mode === 'both' ? 'sbs' : mode;
      applyLayoutClass();
    });
  });
  ...
  google.script.run.withSuccessHandler(function(receivedPreferences) {
    ...
    document.getElementById('addFormat').value = defaultMode === 'he' ? 'he' : (defaultMode === 'en' ? 'en' : (preferences.bilingual_layout_default === 'he-top' ? 'stack' : 'sbs'));
    syncVersionControlContainers();
    applyLayoutClass();
  }).getPreferences();
