...
function saveAiLessonDefaults_(payload) {
  ...
  if (payload && payload.additionalInstructions !== undefined) {
    userProperties.setProperty('ai_additional_instructions_default', String(payload.additionalInstructions || '').trim());
  }
  if (payload && payload.includeOriginal !== undefined) {
    userProperties.setProperty('ai_include_original_default', String(payload.includeOriginal === true));
  }
  if (payload && payload.includeTranslation !== undefined) {
    userProperties.setProperty('ai_include_translation_default', String(payload.includeTranslation === true));
  }
  if (payload && payload.includeTransliteration !== undefined) {
    userProperties.setProperty('ai_include_transliteration_default', String(payload.includeTransliteration === true));
  }
  if (payload && payload.includeEducatorNotes !== undefined) {
    userProperties.setProperty('ai_include_educator_notes_default', String(payload.includeEducatorNotes === true));
  }
  if (payload && payload.includeDiscussionPrompts !== undefined) {
    userProperties.setProperty('ai_include_discussion_prompts_default', String(payload.includeDiscussionPrompts === true));
  }
  return true;
}
